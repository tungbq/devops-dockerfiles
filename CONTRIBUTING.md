...
The following information provides a set of guidelines for contributing to the tungbq/devops-dockerfiles chain main repo. Use your best judgment, and, if you see room for improvement, please propose changes to this document.
...
1. [Fork the repository](https://github.com/tungbq/devops-dockerfiles).
...
8. Next, rinse and repeat the following:
    ...
    3. Create a PR on the devops-dockerfiles repository. There should be a PR template to help you do so.
